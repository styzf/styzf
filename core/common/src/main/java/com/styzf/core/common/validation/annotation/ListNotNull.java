...
import com.styzf.core.common.validation.ListNotNullValidatorImpl;
...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = ListNotNullValidatorImpl.class)//此处指定了注解的实现类为ListNotHasNullValidatorImpl
