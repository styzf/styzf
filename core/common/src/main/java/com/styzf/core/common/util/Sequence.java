...
public class Sequence {
    ...
    public Sequence(long workerId, long datacenterId) {
        if (workerId > maxWorkerId || workerId < 0) {
            Assert.throwException("", "worker Id can't be greater than {0} or less than 0", new Object[] {maxWorkerId});
        }
        if (datacenterId > maxDatacenterId || datacenterId < 0) {
            Assert.throwException("", "datacenter Id can't be greater than {0} or less than 0", new Object[] {maxWorkerId});
        }
