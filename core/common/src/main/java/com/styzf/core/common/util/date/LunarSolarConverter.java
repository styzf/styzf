...
public class LunarSolarConverter {
	...
	private static Date solarFromInt(long g) {
		...
		/*
		 * Solar solar = new Solar(); solar.solarYear = (int) y;
		 * solar.solarMonth = (int) mm; solar.solarDay = (int) dd;
		 */
		String d = (int) y + "-" + (int) mm + "-" + (int) dd;
		return DateUtil.stringToDate(d, DateStyle.YYYY_MM_DD);
	}

	public static Date lunarToSolar(Lunar lunar) {
	...
	public static Lunar solarToLunar(Date solar) {
		int solarYear = DateUtil.getYear(solar);
		int solarMonth = DateUtil.getMonth(solar);
		int solarDay = DateUtil.getDay(solar);
